...
### Семинар 6. 
Необходимо обучить модель **бинарной** классификации на датасете Cats and Dogs. Точность модели должна быть выше 0.8 размер модели не должен превышать 50 МБ. Если Вы загрузите модель большего размера или меньшей точностью, то будет начислено 3 балла. .env файл находится в папке гугл диска вместе с лекциями.
