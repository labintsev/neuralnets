...
Ссылки на результаты   [первого](grads/scores.csv), [второго](grads/scores_2.csv), [третьего](grads/scores_3.csv), [четвертого](grads/scores_4.csv)  семинаров.    
Ссылки на результаты  3 и 4 семинара, оцениваемых [вручную](grads/scores_manual_34.csv).  
