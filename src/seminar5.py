...
def train(net='/Users/denidashaev/PycharmProjects/neuralnets/models/models/my_conv_net'):
...
def draw_weights(net_path):
    ...
    for i in range(64):
        ...
        plt.axis('off')
    plt.savefig('/Users/denidashaev/PycharmProjects/neuralnets/output/seminar5/weights.png')


if __name__ == '__main__':
    NET_PATH = '/Users/denidashaev/PycharmProjects/neuralnets/models/my_conv_net'
    train(NET_PATH)
