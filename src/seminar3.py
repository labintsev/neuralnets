...
if __name__ == '__main__':
    ...
    model = TwoLayerNet()
    #model = TwoLayerNet(n_input, n_output, hidden_layer_size)
    #loss_history = model.fit(X, y, learning_rate=0.001, num_iters=10000, batch_size=4, verbose=True)
